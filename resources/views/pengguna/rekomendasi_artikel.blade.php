    ...
    <div class="page-header">
        ...
        <div class="header-content">
            ...
            <div class="header-text">
                ...
                <p>Kumpulan artikel kesehatan dan gizi yang sesuai dengan hasil skrining Anda.</p>
            </div>
    ...
    <div class="article-container-box">
        ...
        <div class="article-grid">
            ...
            @forelse($artikels as $artikel)
                ...
                <a href="{{ route('pengguna.artikel.detail', $artikel->id) }}"
                    class="article-card">
        ...
        <div class="article-container-box">
            <div class="article-grid">
                @<div class="page-header">forelse($artikels as $artikel)
