...
@section('title', 'Skrining Diet - Langkah 2')
...
<div class="skrining-container">
    ...
    <div class="skrining-box">
        <h4 class="fase-title">Fase 2 — Pola Diet & Gaya Hidup</h4>
        ...
        <form action="{{ route('skrining.langkah2.simpan') }}" method="POST">
            ...
            <div class="question-item">
                ...
                <span class="question-text">
                    {{ $loop->iteration + 5 }}. {{ $question->pertanyaan }}
                </span>
            ...
            <div class="footer-nav">
                <a href="{{ route('skrining.langkah1') }}" class="btn-nav">
                    ← Kembali
                </a>
