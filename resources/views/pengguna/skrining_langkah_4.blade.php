...
<div class="skrining-container">
    ...
    <div class="skrining-box">
        ...
        <div class="result-section" style="margin-top:20px;">
            ...
            <div style="font-size:42px;font-weight:800;color:#0F172A;margin:10px 0;">
                {{ $screening->imt }}
            </div>
            ...
            <p style="margin-top:14px;">{{ $pesan_imt }}</p>
        </div>
        ...
        <div class="result-section" style="margin-top:20px;">
            ...
            <div style="font-size:38px;font-weight:800;color:#0F172A;margin:8px 0;">
                {{ $total_skor }}
