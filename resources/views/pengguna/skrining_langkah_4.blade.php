...
@section('content')
    ...
    @php
        $warna_diet = match ($status_diet) {
            'Pola Diet Baik' => '#27ae60',
            'Pola Diet Cukup' => '#2980b9',
            'Pola Diet Kurang Baik' => '#e67e22',
            'Pola Diet Buruk' => '#c0392b',
            default => '#95a5a6',
        };
    ...
    <div class="skrining-container">
        ...
        <div class="skrining-box">
            ...
            <div class="result-section">
                ...
                <div class="status-pill" style="background:{{ $warna_diet }};color:#fff;margin-top:12px;">
                    {{ $status_diet }}
                </div>

                <p class="advice-text" style="margin-top:12px;">
                    {{ $pesan_diet }}
                </p>
            ...
            <div class="result-section" style="margin-top:16px;">
                ...
                <div style="font-size:36px;font-weight:800;color:#2c3e50;margin:8px 0;">
                    {{ $total_skor }}
                    <span style="font-size:16px;font-weight:400;color:#888;">/ 40</span>
                </div>
