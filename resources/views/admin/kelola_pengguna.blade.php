...
@section('content')
    <link rel="stylesheet" href="{{ asset('assets/css/admin/kelola_pengguna.css') }}">
        ...
        <div class="page-header">
            <div class="header-title-row">
                ...
                <div class="header-text">
                    ...
                    <p>Manajemen data akun seluruh pengguna aplikasi</p>
                </div>
            </div>
        </div>
...
@endif
        ...
        <div class="add-account-form-container">
            ...
            <form action="{{ route('admin.simpan_pengguna') }}" method="POST">
                @csrf
                ...
                <div class="form-grid-2">
                    ...
                    <div class="form-group-add">
                        ...
                        <input type="number" name="umur" min="1" placeholder="25" required
                            class="form-control-input">
                    </div>
                </div>
        ...
        <div class="content-box">
            ...
            <form method="GET" action="{{ route('admin.kelola_pengguna') }}">
                    ...
                    @forelse ($users as $index => $user)
                        <tr>
                            ...
                            <td style="text-align: center;">
                                ...
                                <form action="{{ route('admin.hapus_pengguna', $user->id) }}" method="POST"
        ...
        <div class="modal-box">
            ...
            <form id="formEditUser" method="POST">
                ...
                <div class="modal-row-custom">
                    <div class="modal-label-custom">Nama Pengguna</div>
