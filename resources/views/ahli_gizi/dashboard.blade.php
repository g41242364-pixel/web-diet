...
@section('content')
    ...
    <section class="welcome-banner-gizi">
        <div class="banner-text-content">
            ...
            <form action="{{ route('ahligizi.toggleStatus') }}" method="POST" style="display:inline;">
                @csrf
                <button type="submit" class="btn-status {{ auth()->user()->is_online ? 'btn-online' : 'btn-offline' }}">
    ...
    <div class="panel-card">
        ...
        <p class="panel-subtitle">Persentase kategori indeks massa tubuh pasien yang ditangani.</p>

        <div class="panel-card">
            <h4>🎯 Progres Target Diet Pasien</h4>
            <p class="panel-subtitle">Monitoring perkembangan pencapaian target berat badan pasien.</p>
            ...
            @empty
                <p style="color:#aaa;font-size:13px;text-align:center;padding:20px;">
                    Belum ada data progress diet pasien.
                </p>
            @endforelse
        </div>
    </div>
